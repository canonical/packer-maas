...
build {
  ...
  provisioner "file" {
    source      = "local_files/MLNX_OFED_LINUX-24.10-2.1.8.0-rhel9.5-x86_64.tgz"
  ...
  provisioner "shell" {
    inline = [
      "cd /tmp",
      "tar -xzf mofed.tgz",
      "cd MLNX_OFED_LINUX-24.10-2.1.8.0-rhel9.5-x86_64",
...
build {
  ...
  provisioner "file" {
    source      = "local_files/nvidia-driver-local-repo-rhel9-570.124.06-1.0-1.x86_64.rpm"
    destination = "/tmp/nvidia.rpm"
  }
